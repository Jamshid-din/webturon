            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <ul class="nav nav-tabs" id="pills-tab">             
                    <li class="nav-item">
                        <a class="nav-link text-white" id="pills-menu-tab" href="{{ route('admin-menu-personal') }}">Parent Menu </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white active" id="pills-submenu-tab" href="{{ route('admin-menu-personal-sub') }}">Sub Menu</a>
                    </li>
                </ul>                
                <p class="card-category"> <!-- Here you can manage personal sub docuements --></p>
              </div>
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('store-personal-sub-menu') }}" enctype="multipart/form-data">
                    @csrf
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('admin-menu-personal-sub') }}">
                    @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form id="updateForm" class="form" method="POST" action="{{ route('update-personal-sub-menu') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 m-auto">
                        ...
                        <h4 class="text-center">Deleting the item also causes its sub files which means they also will be deleted permanently. </h4>
...
<script>
  $(document).ready(function(){
    ...
    $('.editLink').click(function(){
      ...
      $.ajax({
        url: '/admin-menu-personal-sub/' + itemId,
        data: {
          _token: csrf_token,
          id    : itemId
        },
        ...
        success: function(result){
          let oldPersonalSub = result['oldSubMenu']
          ...
          $('#sub_menu_id').val(oldPersonalSub.id)
          $('#updateTitle_uz').val(oldPersonalSub.title_uz)
          $('#updateTitle_ru').val(oldPersonalSub.title_ru)

          if(oldPersonalSub.status){
          ...
          $('#updateParentMenu').selectpicker('val',oldPersonalSub.arch_menu_id);
