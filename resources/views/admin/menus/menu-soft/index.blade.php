@extends('layouts.app', ['activePage' => 'soft-menu', 'titlePage' => __('Software Menu'),'show' => 'menu'])
            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <ul class="nav nav-tabs" id="pills-tab">             
                    <li class="nav-item">
                        <a class="nav-link text-white active" id="pills-menu-tab" href="{{ route('admin-menu-soft') }}">Parent Menu </a>
                    </li>
                </ul>                
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('admin-menu-soft.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="number" class="form-control" name="sort" min="0" max="255" placeholder="Sort..." required>
                      </div>
                    </div>
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form id="searchForm" class="form" method="POST" action="{{ route('admin-menu-soft') }}">
                    @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="number" class="form-control" name="sort" id="searchSort" min="0" max="255" placeholder="Sort..." value="{{ $sort??'' }}">
                        </div>
                      </div>
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('admin-menu-soft.update', 0) }}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
