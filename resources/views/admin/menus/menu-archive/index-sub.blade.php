@extends('layouts.app', ['activePage' => 'archive-menu', 'titlePage' => __('Archive Menu'),'show' => 'menu'])
            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <ul class="nav nav-tabs" id="pills-tab">             
                    <li class="nav-item">
                        <a class="nav-link text-white" id="pills-menu-tab" href="{{ route('admin-menu-archive') }}">Parent Menu </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white active" id="pills-submenu-tab" href="{{ route('admin-menu-archive-sub') }}">Sub Menu</a>
                    </li>
                </ul>                
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('store-arch-sub-menu') }}" enctype="multipart/form-data">
                    @csrf
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('admin-menu-archive-sub') }}">
                    @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form id="updateForm" class="form" method="POST" action="{{ route('update-arch-sub-menu') }}" enctype="multipart/form-data">
                    @csrf
...
<script>
  $(document).ready(function(){
    ...
    $('.editLink').click(function(){
      ...
      $.ajax({
        url: '/admin-menu-archive-sub/' + itemId,
        data: {
          _token: csrf_token,
          id    : itemId
        },
        ...
        success: function(result){
          ...
          $('#sub_menu_id').val(oldArchSub.id)
          $('#updateTitle_uz').val(oldArchSub.title_uz)
          $('#updateTitle_ru').val(oldArchSub.title_ru)

          if(oldArchSub.status){
          ...
          $('#updateParentMenu').selectpicker('val',oldArchSub.arch_menu_id);
