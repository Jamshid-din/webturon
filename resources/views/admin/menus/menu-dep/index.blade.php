            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <ul class="nav nav-tabs" id="pills-tab">             
                    <li class="nav-item">
                        <a class="nav-link text-white active" id="pills-menu-tab" href="{{ route('admin-menu-dep') }}">Parent Menu </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" id="pills-submenu-tab" href="{{ route('admin-menu-dep-sub') }}">Sub Menu</a>
                    </li>
                </ul>                
                <p class="card-category"> <!-- Here you can manage Department Menu --></p>
              </div>
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('store-dep-menu') }}" enctype="multipart/form-data">
                    @csrf
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form id="searchForm" class="form" method="POST" action="{{ route('admin-menu-dep') }}">
                    @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-10 m-auto">
                  <form class="form" method="POST" action="{{ route('update-dep-menu') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 m-auto">
                        ...
                        <h4 class="text-center">Deleting the item also causes its sub menus and its attributes which means they also will be deleted permanently. </h4>
