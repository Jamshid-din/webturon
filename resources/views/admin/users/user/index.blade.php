@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('User Management'),'show' => 'user'])
                    ...
                    <tbody>
                      ...
                      <tr id="row_{{ $model->id}}">
                        ...
                        <td class="td-actions text-right"> 
                          @if(($model->roles->role_code??'') != 'super_admin')
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
          <div class="modal-header">
            <h5 class="modal-title card-title">Add a new user</h5>
                ...
                <form class="form" method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <div class="input-group-text"><i class="material-icons">accessibility_new</i></div>
                        </div>
                        <select id="storeRole" class="form-control" data-style="btn btn-link"  name="store_role" data-live-search="true"  required>
                            <option value="" disabled selected> Select a Role </option>
                          @foreach($roles as $key => $value)
                            @if(old('store_role') == $value->id)
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text" id="storeName" class="form-control" name="store_name" placeholder="Name..." value="{{ old('store_name') }}" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <div class="input-group-text"><i class="material-icons">mail_outline</i></div>
                        </div>
                          <input type="email" id="storeEmail" class="form-control" id="storeEmail" name="email" value="{{ old('email')   }}" placeholder="{{ __('Email...') }}" >
                      </div>
                      @if ($errors->has('email'))
                        <div id="storeEmail-error" class="error text-danger pl-3" for="storeEmail" style="display: block;">
                      ...
                      <div class="input-group">
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="store_status" id="storeStatusActive" value="1" checked> Active
                            <span class="circle">
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="store_status" id="storeStatusPassive" value="0"> Passive
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                          </label>
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-10 m-auto">
                  <form id="updateForm" class="form" method="POST" action="{{ route('user.update', 0) }}" enctype="multipart/form-data">
                      @csrf
                      {{ method_field('PATCH') }}
                      <input type="text" name="id" id="user_id" value="" hidden>
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <select class="form-control" data-style="btn btn-link" id="updateRole" name="role" data-live-search="true"  required>
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="text" id="updateName" class="form-control" name="name" placeholder="{{ __('Name...') }}" required>
                        </div>
                        @if ($errors->has('name'))
                          <div id="name-error" class="error text-danger pl-3" for="updateName" style="display: block;">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="email" id="updateEmail" class="form-control" name="email" placeholder="{{ __('Email...') }}" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="password" id="updatePassword" class="form-control" name="password" placeholder="{{ __('Password...') }}">
                        </div>
                        @if ($errors->has('password'))
                        <div id="password-error" class="error text-danger pl-3" for="password" style="display: block;">
                          <strong>{{ $errors->first('password') }}</strong>
                      ...
                      <div class="form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }}">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="password" id="updateConfirmPassword" class="form-control" name="password_confirmation" placeholder="{{ __('Confirm Password...') }}">
                        </div>
                        @if ($errors->has('password_confirmation'))
                        <div id="update_password_confirmation-error" class="error text-danger pl-3" for="updateConfirmPassword" style="display: block;">
                          <strong>{{ $errors->first('password_confirmation') }}</strong>
                        </div>
                        @endif
                      </div>
    ...
    $('.editLink').click(function(){
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          $('#updateRole').selectpicker('val', role.id)
          $('#user_id').val(model.id)
          $('#updateName').val(model.name)
      ...
      $("#deleteConfirm").unbind().click(function() {
        ...
        $.ajax({
          ...
          success: function(result) {
            ...
            $('#responseModal .modal-body p').text(result.success)
