@extends('layouts.app', ['activePage' => 'personal', 'titlePage' => __('Personal'),'show' => 'document'])
...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">Personal Documents</h4>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-10 m-auto">
                <form class="form" method="POST" action="{{ route('store-personal-doc') }}" enctype="multipart/form-data">
                  @csrf
          ...
          <div class="modal-content">
              <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-10 m-auto">
                      <form id="searchForm" class="form" method="POST" action="{{ route('admin-docs-personal') }}">
                        @csrf
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-prepend">
      ...
      <div class="modal-content">
        <div class="card card-signup card-plain">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-10 m-auto">
                <form class="form" id="updateForm"  method="POST" action="{{ route('update-personal-doc') }}" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="status" id="updateActive" value="1"> Active
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                          </label>
                        ...
                        <div class="form-check form-check-radio form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="status" id="updatePassive" value="0"> Passive
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                          </label>
  ...
  $( document ).ready(function() {
    ...
    $('#selectDep').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
      ...
      $.ajax({
        url: '/admin-menu-personal-sub/fetch-sub/'+ optionValue,
        type: 'get',
    ...
    $(".deleteLink").click( function () {
      ...
      $("#deleteConfirm").unbind().click(function() {
        ...
        $.ajax({
          url: '/admin-docs-personal/' + itemId,
          data: {
            _token: csrf_token,
            id    : itemId
          },
    ...
    $('.editLink').click(function(){
      ...
      $.ajax({
        ...
        success: function(result){
          ...
          let oldPersonal = result['oldPersonal']
          ...
          $.each( menu , function( index, value ) {
            if(value.id === oldPersonal.doc_arch_menu_id){
              currentMenu = value
            }
          });
          $.each( subMenu , function( index, sub_value ) {
            if(sub_value.id == oldPersonal.doc_sub_arch_menu_id){
          ...
          $('#doc_id').val(oldPersonal.id)
          $('#updateInputTitle').val(oldPersonal.doc_title)
          $('#updateInputText').val(oldPersonal.doc_text)
          ...
          if(oldPersonal.status === 1){
            $('#updateActive').prop('checked',true)
          }
          else{
            $('#updatePassive').prop('checked', true)
          } 
